...
(Step 5), `VehicleUnit`/`AvailabilityHold`/`AvailabilityCheck` (Step 6) — see
...
`docs/PHASE-2.md`, `docs/PHASE-3.md`, `docs/PHASE-4.md`, `docs/PHASE-5.md` and `docs/PHASE-6.md`.
...
`EligibilityPolicy` is similarly append-only-by-convention: a new version is inserted and every
previous one deactivated, never an in-place update.
